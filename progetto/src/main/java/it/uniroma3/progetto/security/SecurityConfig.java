...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http
		.authorizeRequests()
		.antMatchers("/","/chiSiamo","/doveSiamo","/contatti","/lista","/informazioniAutore","/informazioniQuadro","/dettagliAutore","/dettagliQuadro","/mostraAutoreQuadro","/mostraQuadriAutore","/css/**","/img/**").permitAll()
